...
//                   {course.courseName}
//                 </h2>
//                 <p className="text-sm max-w-2xl mb-4 line-clamp-3">
//                   {course.courseDescription}
//                 </p>
//                 <Link
//                   href={`/courses/${course.courseId}`}
//                   className="bg-white text-red-600 font-semibold py-2 px-6 rounded-full hover:bg-red-600 hover:text-white transition"
//                 >
//                   Read More
//                 </Link>
//               </div>
